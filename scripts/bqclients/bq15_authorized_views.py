...
""" 15) Added support to authorize all / selective views to access the source dataset

 Note : In order to provide the service account access to both the projects, copy the "client_email" key value from service account file
        and add an IAM policy for this user for Bigquery.dataViewer
"""
