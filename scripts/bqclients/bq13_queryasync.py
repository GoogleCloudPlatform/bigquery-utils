...
""" 13) Added support to query Bigquery, added support for running queries asynchronously using python multiprocessing """
...
def set_global_vars(args):
    ...
    global _PROJECT_ID, _DRY_RUN_FLAG, _CRED_FILE, _QUERY, _QUERY_FILE, _LOG_TARGET, _LOGGER_NAME, \
        ...
        _QUERY_RANGE_START, _QUERY_RANGE_END, _MAX_CONCURRENT_PROCESSES
