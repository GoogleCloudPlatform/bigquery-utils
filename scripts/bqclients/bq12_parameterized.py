...
""" 12) Script to query Bigquery with complete parameterized support for all the previous implementations """
...
def set_global_vars(args):
    ...
    global _PROJECT_ID, _DRY_RUN_FLAG, _CRED_FILE, _QUERY, _QUERY_FILE, _LOG_TARGET, _LOGGER_NAME, _CREDENTIALS, _LOG_LEVEL, _LOG_FILE, _QUERY_CACHE_FLAG, _QUERY_PARAMS
