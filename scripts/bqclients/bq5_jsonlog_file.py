...
""" 5) Script to query Bigquery with structured json logging support in a log File """
...
def init_logger():
    """Initializing the logger global variable for file logging"""
    global Logger

    create_directories(_LOG_FILE)

    # Defining handler for a rotating file
