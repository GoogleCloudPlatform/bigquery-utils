...
generate_test_udf_1_input("fn.json_typeof", [
  {
    input_1: "  ('\"\"')",
...
//generate_test_udf_1_input("fn.typeof", [
//  {
//    input_1: "  (b'test')",
...
generate_test_udf_1_input("fn.last_day", [
  {
...
generate_test_udf_2_inputs("fn.percentage_change", [
  {
...
generate_test_udf_2_inputs("fn.percentage_difference", [
  {
...
generate_test_udf_3_inputs("fn.linear_interpolate", [      {
    "input_1": "  CAST(2 AS INT64)",
...
generate_test_udf_3_inputs("fn.ts_linear_interpolate", [      {
...
generate_test_udf_2_inputs("fn.ts_tumble", [
  {
...
generate_test_udf_4_inputs("fn.ts_gen_keyed_timestamps", [
  {
...
generate_test_udf_3_inputs("fn.ts_session_group", [
  {
...
generate_test_udf_3_inputs("fn.ts_slide", [
  {
    input_1: "  CAST('2020-01-01 01:04:59 UTC' AS TIMESTAMP)",
    input_2: " 300",
    input_3: " 600",
...
generate_test_udf_1_input("fn.nlp_compromise_number", [
  {
...
generate_test_udf_1_input("fn.nlp_compromise_people", [
...
generate_test_udf_2_inputs("fn.levenshtein", [
  {
...
//
generate_test_udf_2_inputs("fn.pvalue", [
  {
...
generate_test_udf_1_input("fn.kruskal_wallis", [
  {
...
generate_test_udf_1_input("fn.linear_regression", [
  {
