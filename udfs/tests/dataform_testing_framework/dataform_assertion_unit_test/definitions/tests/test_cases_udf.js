...
const {generate_test_udf} = unit_test_utils;

generate_test_udf("fn.int", [
  {
...
generate_test_udf("fn.json_typeof", [
  {
    input_1: "  ('\"\"')",
...
//  },
//]);
generate_test_udf("fn.url_parse", [
  {
...
generate_test_udf("fn.percentage_change", [
  {
...
generate_test_udf("fn.percentage_difference", [
  {
...
generate_test_udf("fn.linear_interpolate", [      {
    "input_1": "  CAST(2 AS INT64)",
...
generate_test_udf("fn.ts_linear_interpolate", [      {
...
generate_test_udf("fn.ts_tumble", [
  {
...
generate_test_udf("fn.ts_gen_keyed_timestamps", [
  {
...
generate_test_udf("fn.ts_session_group", [
  {
...
generate_test_udf("fn.nlp_compromise_number", [
  {
...
generate_test_udf("fn.nlp_compromise_people", [
...
generate_test_udf("fn.levenshtein", [
  {
...
generate_test_udf("fn.kruskal_wallis", [
  {
...
generate_test_udf("fn.linear_regression", [
  {
