...
generate_udf_test("from_binary", [
    {
        input_1: `CAST("0000000000000000000000000000000000000000000000011110001001000000" AS STRING)`,
...
generate_udf_test("from_hex", [
    {
        input_1: `CAST("000000000001e240" AS STRING)`,
        expected_output: `CAST(123456 AS INT64)`
    },
    {
        input_1: `(NULL)`,
...
generate_udf_test("week_of_month", [
    {
        input_1: `CAST("2020-07-03" AS DATE)`,
        expected_output: `CAST(0 AS INT64)`
    },
    {
        input_1: `CAST("2020-07-08" AS DATE)`,
        expected_output: `CAST(1 AS INT64)`
    },
    {
